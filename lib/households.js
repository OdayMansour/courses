...
module.exports.joinHousehold_get = function (req, res) {
    res.send(
`<html>
  <body>
    <form action="/api/households/joinhousehold/" method="post">
...
module.exports.joinHousehold_post = function (req, res) {
